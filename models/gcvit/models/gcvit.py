...
class GCViT(tf.keras.Model):
    def __init__(self, window_size, dim, depths, num_heads,
        drop_rate=0., mlp_ratio=3., qkv_bias=True, qk_scale=None, attn_drop=0., path_drop=0.1, layer_scale=None, resize_query=False, first_strides=2,
        ...
        self.patch_embed = Stem(dim=dim, first_strides=first_strides, name='patch_embed')
...
def GCViTXXTiny(input_shape=(224, 224, 3), pretrain=False, resize_query=False, first_strides=2, **kwargs):
    name = 'gcvit_xxtiny'
    config = NAME2CONFIG[name]
    ckpt_link = '{}/{}/{}_weights.h5'.format(BASE_URL, TAG, name)
    model = GCViT(name=name, resize_query=resize_query, first_strides=first_strides, **config, **kwargs)
...
def GCViTXTiny(input_shape=(224, 224, 3), pretrain=False, resize_query=False, first_strides=2, **kwargs):
    name = 'gcvit_xtiny'
    config = NAME2CONFIG[name]
    ckpt_link = '{}/{}/{}_weights.h5'.format(BASE_URL, TAG, name)
    model = GCViT(name=name, resize_query=resize_query, first_strides=first_strides, **config, **kwargs)
...
def GCViTTiny(input_shape=(224, 224, 3), pretrain=False, resize_query=False, first_strides=2, **kwargs):
    name = 'gcvit_tiny'
    config = NAME2CONFIG[name]
    ckpt_link = '{}/{}/{}_weights.h5'.format(BASE_URL, TAG, name)
    model = GCViT(name=name, resize_query=resize_query, first_strides=first_strides, **config, **kwargs)
...
def GCViTSmall(input_shape=(224, 224, 3), pretrain=False, resize_query=False, first_strides=2, **kwargs):
    name = 'gcvit_small'
    config = NAME2CONFIG[name]
    ckpt_link = '{}/{}/{}_weights.h5'.format(BASE_URL, TAG, name)
    model = GCViT(name=name, resize_query=resize_query, first_strides=first_strides, **config, **kwargs)
...
def GCViTBase(input_shape=(224, 224, 3), pretrain=False, resize_query=False, first_strides=2, **kwargs):
    name = 'gcvit_base'
    config = NAME2CONFIG[name]
    ckpt_link = '{}/{}/{}_weights.h5'.format(BASE_URL, TAG, name)
    model = GCViT(name=name, resize_query=resize_query, first_strides=first_strides, **config, **kwargs)
